...
if not st.session_state.authenticated:
    st.markdown("""
        <div class="closed-container">
            ...
            <p>Muchas gracias a todos los estudiantes, docentes y visitantes por participar de la <b>Expotécnica 2026</b>.</p>
            <p><b>¡Los esperamos con ansias en la Edición 2027! 🚀⚙️</b></p>
        </div>
    """, unsafe_allow_html=True)
...
def registrar_voto_servidor(id_proyecto_voto, cantidad=1):
    payload_voto = {
